...
export const BloodSeparationListPage: React.FC = () => {
	...
	return (
		<div className="p-8 bg-[#f9fafb] min-h-screen">
			<h2 className="text-2xl font-semibold text-center text-[#236afe] mb-6">
						...
						<TableBody>
							{jobs.map((job) => (
								<TableRow key={job._id} className="hover:bg-[#f9fafb]">
									...
									<TableCell>{job.volume_collected}</TableCell>
									<TableCell>{job.donation_date}</TableCell>

									<TableCell>{statusVN(job.status)}</TableCell>

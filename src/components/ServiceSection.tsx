...
const serviceData = {
  ...
  serviceCardData: [
    {
      number: "01",
      title: "Đăng ký thông tin để hiến máu",
      description: "Bước đầu tiên, điền thông tin cá nhân và lịch trình hiến máu.",
      links: { label: "Đăng ký ngay", href: "/support/#slide-1" }, 
      icon: serviceIcons.bloodDonation,
    },
    {
      number: "02",
      title: "Kiểm tra sức khỏe",
      description: "Thực hiện các bước kiểm tra sức khỏe để đảm bảo đủ điều kiện hiến máu.",
      links: { label: "Tìm hiểu về kiểm tra sức khỏe", href: "/support/#slide-2" }, // Slide 2
      icon: serviceIcons.healthCheck,
    },
    {
      number: "03",
      title: "Đăng ký thông tin nhận máu",
      description: "Điền thông tin cần thiết để nhận máu.",
      links: { label: "Đăng ký nhận máu", href: "/support/#slide-3" }, // Slide 3
      icon: serviceIcons.bloodStorage,
    },
    {
      number: "04",
      title: "Hiến máu",
      description: "Thực hiện hiến máu tại địa điểm đã đăng ký.",
      links: { label: "Xem hướng dẫn hiến máu", href: "/support/#slide-4" }, // Slide 4
      icon: serviceIcons.bloodDonation,
    },
    {
      number: "05",
      title: "Nhận máu",
      description: "Khi cần nhận máu, điền thông tin yêu cầu nhận máu.",
      links: { label: "Đến trang nhận máu", href: "/support/#slide-5" }, // Slide 5

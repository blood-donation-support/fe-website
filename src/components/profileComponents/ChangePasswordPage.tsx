...
const ChangePasswordPage: React.FC = () => {
	...
	const validateFields = () => {
		...
		if (!formData.old_password) errors.old = "Nhập mật khẩu hiện tại!";
			...
			errors.old =
				"Mật khẩu hiện tại phải từ 6-50 ký tự, chứa chữ hoa, chữ thường, số, ký tự đặc biệt.";
		if (!formData.password) errors.password = "Nhập mật khẩu mới!";
		else if (!passwordRegex.test(formData.password))
			errors.password =
				"Mật khẩu mới phải từ 6-50 ký tự, chứa chữ hoa, chữ thường, số, ký tự đặc biệt.";
		...
		<div className="container mx-auto mb-20">
			...
			>
				...
				<form
					...
					className="pl-24 max-w-2xl mx-auto"
				>
					<TextField

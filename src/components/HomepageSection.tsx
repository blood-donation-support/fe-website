        ...
        <section className="w-full h-screen relative  items-stretch snap-start overflow-hidden">          
        	<HeaderComponent isHomepage ={true}/>
				...
				<motion.div
					...
					className="absolute top-1 left-[33vw] w-[80vh] h-[130vh] -translate-x-1/2 origin-bottom -translate-y-1/2 z-20"
					>
					<div className="relative w-[80vh] h-[130vh] flex items-center justify-center">
						<img
							src="https://www.secondmedic.com/app/asset/consult/image/apollo-banner-doctor.webp"
							alt="Doctor"
							className="w-[80vh] h-[130vh] object-cover "
							style={{ zIndex: 2 }}
							/>
					</div>
				</motion.div>
